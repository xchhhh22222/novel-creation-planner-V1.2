...
description: V1.6 素材池驱动小说创造规划器：在V1.5候选池基础上新增人物生态硬门，支持多女主候选池、长线反派池、配角池、人物关系发动机与势力代表人物绑定；金手指不再默认绑定每日预算型，只有选中预算菜单型时才启用24+商品菜单硬门。
---
...
9. **构造前100章局部 Scale + 人物生态**：先从素材库广泛召回，再筛选。体系先建4—6套候选池再激活2—3套；功法6—10选3—5；武技8—12选4—6；法宝/装备5—8选2—4；人物层必须从 character-card / 人物功能素材建立候选池。若用户明确多女主：女主候选4—8，前100章激活3—4；长线反派候选3—6，激活2—4；配角3—6；关系发动机4—8；每个active势力至少绑定1名代表人物。所有新书名称必须原创重命名。只有每日预算类金手指才额外构建24+商品原型、每日10项明码标价菜单和多选购买规则。
