...
description: V1.3 单书选项型小说创造规划器：市场层只学习节奏/情绪/钩子结构；素材层必须为世界、体系、势力、资源和金手指提供真实来源；创造层只构造一个共享故事核心，再给3个书名、3个开篇、3个素材溯源金手指候选，等待用户选择后才进入战略目标物与前100章高潮倒推。
---
...
`赛道 → Top10结构学习 → 3本前20章深拆 → structural lessons → 素材来源硬门 → 一个共享故事核心 → 3书名 + 3开篇 + 3金手指 → 用户选择 → strategic target → 前100章两个大高潮 → 高潮倒推`
...
9. **继续素材调度**：补 technique、artifact、战略目标物、高潮母型等；战略目标物必须有素材支撑。
10. **设计前100章约2个大高潮**：默认30—45章与80—100章；高潮2必须由高潮1后果推出。
11. **从高潮反推故事脊柱**：每个高潮4—8个 backward beats，再填小目标、小高潮和钩子。
12. **输出 GAP 与来源链**：任何核心组件缺素材都显式报告，不用无来源原创掩盖。
